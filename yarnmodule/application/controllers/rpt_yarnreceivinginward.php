...
class rpt_yarnreceivinginward extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('v_rpt_yarnreceivinginward');
        $this->load->view('footer');
    }

    public function reportYarnReceivingInward() {
        ...
        $allServices = $reportYarnInward->yarnReceivingDateWise($fromdate, $todate);
        
        $yarnInwardSummary = $reportYarnInward->yarnReceivingDateWiseSummary($fromdate, $todate);
...
//        $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, PDF_HEADER_STRING, array(0, 64, 255), array(0, 64, 128));
        $pdf->SetHeaderData("", "", 'PREMIER TOWELS', 'Yarn Receiving (Inward)');
        ...
        <table border="1">
            <thead>
                <tr>
                    ...
                    <td width="15%" height="25px" align="center"><b>Broker</b></td>  
        ...
        foreach ($allServices as $allData) {
            $html .= '                
                <tr><td width = "08%" align="center">' . date("d-m-Y", strtotime($allData['Date'])) . '</td>
                    ...
                    <td width = "15%" align="center">' . $allData['Broker'] . '</td>
                    <td width = "15%" align="center">' . $allData['Mill'] . '</td>
                    <td width = "10%" align="center">' . $allData['Brand'] . '</td>
                    <td width = "07%" align="center">' . $allData['CountName'] . '</td>
                    <td width = "07%" align="right">' . $allData['Shortage'] . '<label>&nbsp;</label></td>
        ...
        foreach ($yarnInwardSummary as $summaryData) {
            ...
            $html .= '                
                <tr>
                    ...
                    <td width = "07%" align="right">' . number_format($summaryData['Shortage'], $decimalPoints) .'<label>&nbsp;</label></td> 
        ...
        $html .= '<tr>
                        ...
                        <td width = "07%" align="right">' . number_format($sumShortage, $decimalPoints) . '<label>&nbsp;</label></td>
        ...
        //This method has several options, check the source code documentation for more information.
        $pdf->Output('Yarn Receiving (Inward) '.$dateone.' to '.$datetwo.'.pdf', 'I');
    }
