...
class rpt_purchasecontractsclosed extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('v_rpt_purchasecontractsclosed');
        $this->load->view('footer');
    }

    public function reportPurchaseContractsClosed() {
        ...
        $allServices = $reportPCAll->purchaseContractsClosed($fromdate, $todate);
...
//        $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, PDF_HEADER_STRING, array(0, 64, 255), array(0, 64, 128));
        $pdf->SetHeaderData("", "", 'PREMIER TOWELS', 'Purchase Contract Closed');
        ...
        <table border="1">
            <thead>
                <tr>
                    ...
                    <td width="08%" height="25px" align="center"><b>Seller Contract #</b></td>
        ...
        foreach ($allServices as $allData) {
            $html .= '                
                <tr><td width = "08%" align="center">' . date("d-m-Y", strtotime($allData['Date'])) . '</td>
                    <td width = "08%" align="center">' . $allData['SellerContractNo'] . '</td>
        ...
        //This method has several options, check the source code documentation for more information.
        $pdf->Output('Purchase Contracts Closed '.$dateone.' to '.$datetwo.'.pdf', 'I');
    }
