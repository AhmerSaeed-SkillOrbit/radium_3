...
class rpt_stockposition extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('v_rpt_stockposition', $dataArray);
        $this->load->view('footer');
    }

    public function reportStockPosition() {
        ...
        $allServices = $reportStockPosition->yarnStockPosition($wareHouseID);
        $summary = $reportStockPosition->yarnStockPositionSummary($wareHouseID);
        ...
        $pdf->SetHeaderData("", "", 'PREMIER TOWELS', 'Stock Position');
        ...
        $html = '<span><label><b>Ware house: </b>' . $allServices[0]['WarehouseName'] . '</label></span><br>'
        ...
        //This method has several options, check the source code documentation for more information.
        $pdf->Output('Stock Position-' .$allServices[0]['WarehouseName'] . '.pdf', 'I');
    }
