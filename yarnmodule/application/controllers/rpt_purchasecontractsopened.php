...
class rpt_purchasecontractsopened extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('v_rpt_purchasecontractsopened');
        $this->load->view('footer');
    }

    public function reportPurchaseContractsOpened() {
        ...
        $allServices = $reportPCAll->purchaseContractsOpened($fromdate, $todate);
...
//        $pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE, PDF_HEADER_STRING, array(0, 64, 255), array(0, 64, 128));
        $pdf->SetHeaderData("", "", 'PREMIER TOWELS', 'Purchase Contract Opened');
        ...
        //This method has several options, check the source code documentation for more information.
        $pdf->Output('Purchase Contracts Opened '.$dateone.' to '.$datetwo.'.pdf', 'I');
    }
