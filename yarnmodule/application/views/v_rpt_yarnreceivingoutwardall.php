            ...
            <div class="box box-primary">
                <div class="box-body">  
                    <form id="addcomplaintmodes" name="addcomplaintmodes" onSubmit="" method="post"
                              action="<?= base_url() ?>index.php/rpt_yarnreceivingoutwardall/reportYarnReceivingOutwardall">
                            <fieldset>
                                ...
                                <div class="" style="margin-left: 20px;">
                                    ...
                                    <div class="pull-left col-md-6" style="margin-left: 0px;margin-top: 20px;"><br>
