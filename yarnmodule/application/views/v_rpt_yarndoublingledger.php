            ...
            <div class="box box-primary">
                <div class="box-body"> 
                    <form id="addcomplaintmodes" name="addcomplaintmodes" onSubmit="" method="post"
                          action="<?= base_url() ?>index.php/rpt_yarndoublingledger/reportYarnDoublingLedger">
                        <fieldset>
                            <legend>Ledger Party Wise</legend>
                            <div class="" style="margin-left: 20px;">
                                ...
                                <div id="" class="pull-left col-xs-12 col-sm-6 col-md-6" style="margin-top: 20px;">
                                    ...
                                    <select id="idPartyType" name="idPartyType" class="form-control" style="width: 300px;" onchange="updateCombo()" >
                                        <option value="Select Party Type">Select Party Type</option>                                       
                                        <?php
                                ...
                                <div id="" class="pull-left col-xs-12 col-sm-6 col-md-6" style="margin-top: 20px;">
                                    ...
                                    <select id="idParty" name="idParty" class="form-control" style="width: 300px;">
...
<script>
    ...
    function updateCombo() {
        var partyType = $("#idPartyType").val();
        $.ajax({
            url: "<?= base_url() ?>index.php/rpt_yarndoublingledger/getParties",
            type: "POST",
            data: {data: partyType},
            success: function(data) {
                if (data.length > 0) {
                    ...
                    $("#idParty").html('');
                    $("#idParty").append($("<option>Select Party</option>"));
                    $.each(parsedData, function(index, name) {
                        $("#idParty").append($("<option></option>").val(name['Party_id']).html(name['CompanyName']));
                        });
                    } 
                }
            });
