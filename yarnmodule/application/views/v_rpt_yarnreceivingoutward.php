            ...
            <div class="box box-primary">
                <div class="box-body"> 
                    <form id="addcomplaintmodes" name="addcomplaintmodes" onSubmit="" method="post"
                          action="<?= base_url() ?>index.php/rpt_yarnreceivingoutward/reportYarnReceivingOutward">
                        <fieldset>
                            <legend>Yarn Delivery (Outward)</legend>
                            <div class="" style="margin-left: 20px;">
                                ...
                                <div id="" class="pull-left col-xs-12 col-sm-6 col-md-6" style="margin-top: 20px;">
                                    ...
                                    <select id="idPartyType" name="idPartyType" class="form-control" style="width: 300px;">
