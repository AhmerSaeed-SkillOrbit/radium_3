                        ...
                        <form id='greighFabricDeliveryForm' name='greighFabricDeliveryForm' role='form' method='post' action='<?= base_url() ?>index.php/greighfabricdelivery/Add' onSubmit='return validateDeliveryForm()'> 
                            ...
                            <div id='deliveryDiv'> 
                                <div id='' class='pull-left col-xs-12 col-sm-6 col-md-6' style='margin-top: 20px;'> 
                                    <label>GFDC#</label> 
                                    <input id='GFDC' name='GFDC' type='text' value='<?php
                                    if ($gfdc) {
                                        echo $gfdc;
                                    }
                                ...
                                <div id='' class='pull-left col-xs-12 col-sm-6 col-md-6' style='margin-top: 20px;'> 
                                    ...
                                    <select id='WeaverName' name='WeaverName' class='form-control' style='width:200px;'><option value='0'>Select A/C Weaver</option><?php foreach ($weaverList as $key) { ?><option value='<?= $key['Party_id'] ?>'><?= $key['CompanyName'] ?></option><?php } ?></select>                                                     
                                </div> 
                            ...
                            <fieldset> 
                                <div class='box-body table-responsive'> 
                                    ...
                                    foreach ($itemList as $key) {
                                        ?><option value='<?= $key['item_id'] ?>'><?= $key['ItemCode'] ?></option><?php } ?></select><div class='pull-left col-xs-12 col-sm-6 col-md-6 form-group has-error form-error error-ItemCode' style='width:0px;margin-left:0px;display:none;'></div></td>
                                    ...
                                    ?>' type='number' step='any' min='0' class='form-control' style='width:75px'><div class='form-group has-error form-error error-Rolls' style='width:0px;margin-left:0px;display:none;'> 
                                                    ...
                                                    <td tag=''><input id='Pieces' name='Pieces[]' value='<?php
                                                        ...
                                                        ?>' type='number' step='any' min='0' class='form-control' style='width:75px'><div class='form-group has-error form-error error-Pieces' style='width:0px;margin-left:0px;display:none;'> 
                                                            <label class='control-label' for='inputError'>Enter Pieces!</label></div></td> 
                                                    <td tag=''><input id='Weight' name='Weight[]' value='<?php
                                                        if ($weight) {
                                                            echo $weight;
                                                        }
                                                        ?>' type='number' step='any' min='0' class='form-control' style='width:75px'><div class='form-group has-error form-error error-Weight' style='width:0px;margin-left:0px;display:none;'> 
