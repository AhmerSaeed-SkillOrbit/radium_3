            ...
            <div class="box box-primary">
                <div class="box-body"> 
                    <form id="addcomplaintmodes" name="addcomplaintmodes" onSubmit="" method="post"
                          action="<?= base_url() ?>index.php/rpt_yarnledger/reportYarnLedger">
                        <fieldset>
                            <legend>Yarn Ledger</legend>
                            <div class="" style="margin-left: 20px;">
                                <div id="" class="pull-left col-xs-12 col-sm-6 col-md-6" style="margin-top: 20px;">
                                    ...
                                    <div class="input-group" style="width: 300px;">
                                        ...
                                        <input id="FromDate" name="FromDate" type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask ma>
                                    </div>
                                ...
                                <div id="" class="pull-left col-xs-12 col-sm-6 col-md-6" style="margin-top: 20px;">
                                    ...
                                    <select id="idMill" name="idMill" class="form-control" style="width: 300px;">
                                ...
                                <div id="" class="pull-left col-xs-12 col-sm-6 col-md-6" style="margin-top: 20px;">
                                    ...
                                    <select id="idCount" name="idCount" class="form-control" style="width: 300px;">
                                ...
                                <div class="pull-left col-xs-12 col-sm-6 col-md-6" style="margin-left: 0px;"><br>
