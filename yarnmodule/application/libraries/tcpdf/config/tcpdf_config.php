 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Premier Towels');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'PREMIER TOWELS');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'PREMIER TOWELS');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Daily ResourceBook Reports");
